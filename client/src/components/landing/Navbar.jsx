        ...
        <header className="py-4 bg-white/5 backdrop-blur-sm sticky top-0 z-50 animate-fade-in animation-delay-0">
            <nav className="container mx-auto px-6 flex justify-between items-center">
                <div className="flex items-center space-x-2">
                    <span className="text-2xl font-bold text-indigo-400 animate-slide-up animation-delay-100">Submi</span>
                    <span className="text-2xl font-bold ml-[-7px] text-white animate-slide-up animation-delay-200">ttly</span>
                </div>
